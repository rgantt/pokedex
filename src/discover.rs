                ...
                commands: vec![
                    CommandInfo {
                        ...
                        flags: vec![
                            ...
                            FlagInfo { flag: "--method".to_string(), description: "catch, breed, trade, transfer, gift, raid, research, evolve".to_string(), default: None },
                            FlagInfo { flag: "--shiny".to_string(), description: "Mark as shiny".to_string(), default: None },
                            FlagInfo { flag: "--alpha".to_string(), description: "Mark as alpha (Legends: Arceus / Z-A)".to_string(), default: None },
                            FlagInfo { flag: "--in-home".to_string(), description: "Mark as transferred to HOME".to_string(), default: None },
            ...
            Resource {
                ...
                commands: vec![
                    ...
                    CommandInfo {
                        ...
                        usage: "pokedex home missing [--dex=national|kanto|johto|hoenn|sinnoh|...] [--limit=N] [--offset=N]".to_string(),
